...
public class IATest extends TestSetup {
	...
	public void addCollectorTest(String switchName) throws Exception{
		if(!iaIndex.addCollector(switchName,user,passwd)) {
			...
			com.jcabi.log.Logger.info("addCollector", "Successfully added & verified collector"+switchName);
		}
	}
	...
	*/
	@Test(groups={"smoke","regression"},dependsOnMethods={"logintoIA"},description="src IP tagging test")
	public void tagTest() throws Exception{
		System.out.println("Current working Directory = " +
	    System.getProperty("user.dir"));
		//String fileLoc = System.getProperty("user.dir")+"/src/test/resources/srcIp.csv";
		String fileLoc = "C:\\Documents and Settings\\hello\\My Documents\\documents\\xls-sample2.xls";
